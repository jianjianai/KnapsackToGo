...
public class io {
    public static void jiazaibeibao(Player wanjia){//用于加载玩家背包
        ...
        try {
            ...
            System.out.println("[跨服背包同步]:背包加锁失败，可能导致刷物品，请检查磁盘空间或读取权限！");
        }
        ...
        System.out.println("[跨服背包同步]:加载用时间： "+(endTime-startTime)+"ns");
    }
    public static void baocunbeobao(Player wanjia){//用于保存玩家背包
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("[跨服背包同步]:保存失败,玩家背包未保存，，请检查写入权限，或磁盘空间");
        }
        long endTime = System.currentTimeMillis();
        System.out.println("[跨服背包同步]:保存用时： "+(endTime-startTime)+"ns");
    }
    public static void jiashuo(String wanjia){
        ...
        try {
            ...
            System.out.println("[跨服背包同步]:加锁失败，可能导致刷物品，请检查写入权限，或磁盘空间");
        }
    }
    public static void jieshuo(String wanjia){
        ...
        try {
            ...
            System.out.println("[跨服背包同步]:解锁失败，可能导致玩家物品正常进入服务器，请检查写入权限，或磁盘空间");
        }
    }
